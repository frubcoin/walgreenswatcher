...
CVS_PROXY_URL = os.getenv("CVS_PROXY_URL", "").strip()
CVS_PROXY_URLS = _env_csv("CVS_PROXY_URLS")
if CVS_PROXY_URL and CVS_PROXY_URL not in CVS_PROXY_URLS:
    CVS_PROXY_URLS.insert(0, CVS_PROXY_URL)
